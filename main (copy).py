...
class UnitTests(unittest.TestCase):
  def X_calculate(self):
    ...
    self.assertAlmostEqual(actual,expected,"Different output when calling calculate() with [2,6,2,8,4,0,1,5,7]",)

  def X_calculate2(self):
    ...
    self.assertAlmostEqual(actual,expected,"Different output when calling calculate() with [9,1,5,3,3,3,2,9,0]",)

  def X_calculate_with_few_digits(self):
        self.assertRaisesRegex(ValueError,"It needs to have 9 numbers.",calculate,[2,6,2, 8, 4,0,1,],)
